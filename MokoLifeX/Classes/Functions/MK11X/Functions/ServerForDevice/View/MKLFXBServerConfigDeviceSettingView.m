//
//  MKLFXBServerConfigDeviceSettingView.m
//  MokoLifeX_Example
//
...
@implementation MKLFXBServerConfigDeviceSettingViewModel
@end

@interface MKLFXBServerConfigDeviceSettingView ()
...
@implementation MKLFXBServerConfigDeviceSettingView
...
#pragma mark - setter
- (void)setDataModel:(MKLFXBServerConfigDeviceSettingViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKLFXBServerConfigDeviceSettingViewModel.class]) {
        return;
    }
...
- (MKTextField *)deviceIDField {
    if (!_deviceIDField) {
        ...
        _deviceIDField.textChangedBlock = ^(NSString * _Nonnull text) {
            @strongify(self);
            if ([self.delegate respondsToSelector:@selector(lfxb_mqtt_deviecSetting_deviceIDChanged:)]) {
                [self.delegate lfxb_mqtt_deviecSetting_deviceIDChanged:text];
            }
        };
