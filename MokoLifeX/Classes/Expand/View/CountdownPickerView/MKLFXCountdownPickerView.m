...
@implementation MKLFXCountdownPickerViewModel
@end

@interface MKLFXCountdownPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (nonatomic, copy)void (^timePickerBlock)(MKLFXCountdownPickerViewModel *timeModel);
...
@implementation MKLFXCountdownPickerView

- (void)dealloc{
    NSLog(@"MKLFXCountdownPickerView销毁");
}
