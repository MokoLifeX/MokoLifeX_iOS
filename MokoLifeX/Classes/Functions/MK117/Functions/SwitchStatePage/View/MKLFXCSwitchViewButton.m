...
@implementation MKLFXCSwitchViewButtonModel
@end

@interface MKLFXCSwitchViewButton ()
...
@implementation MKLFXCSwitchViewButton
...
#pragma mark - setter
- (void)setDataModel:(MKLFXCSwitchViewButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKLFXCSwitchViewButtonModel.class]) {
        return;
    }
