...
@interface MKLFXSocketOperation ()
...
@implementation MKLFXSocketOperation
...
#pragma mark - MKLFXSocketOperationProtocol
- (void)lfx_sendDataResult:(BOOL)success
    ...
    if (!success) {
        NSError *error = [[NSError alloc] initWithDomain:@"com.moko.operationError"
                                                    code:-999
                                                userInfo:@{@"errorInfo":@"Send Data Failed"}];
