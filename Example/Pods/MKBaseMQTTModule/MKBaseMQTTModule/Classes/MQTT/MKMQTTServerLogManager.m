//
//  MKMQTTServerLogManager.m
//  MKBaseMQTTModule_Example
//
//  Created by aa on 2022/9/21.
...
@implementation MKMQTTServerLogManager

+ (BOOL)saveDataWithFileName:(nonnull NSString *)fileName
                    dataList:(nonnull NSArray <NSString *>*)dataList {
    if (!fileName || ![fileName isKindOfClass:NSString.class] || fileName.length == 0 || !dataList || ![dataList isKindOfClass:NSArray.class] || dataList.count == 0) {
        return NO;
    }
