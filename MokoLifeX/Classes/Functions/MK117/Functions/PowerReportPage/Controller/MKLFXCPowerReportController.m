...
@implementation MKLFXCPowerReportController

- (void)dealloc {
    NSLog(@"MKLFXCPowerReportController销毁");
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(receivePowerReportInterval:)
                                                 name:MKLFXCReceivePowerReportIntervalNotification
                                               object:nil];
}
...
#pragma mark - note
- (void)receivePowerReportInterval:(NSNotification *)note {
...
- (void)confirmButtonPressed {
    ...
    [MKLFXCMQTTInterface lfxc_configPowerReportInterval:[self.textField.text integerValue]
...
- (void)readDataFromDevice {
    ...
    [MKLFXCMQTTInterface lfxc_readPowerReportIntervalWithDeviceID:self.deviceModel.deviceID
                                                            topic:[self.deviceModel currentSubscribedTopic]
                                                         sucBlock:^{
        [self startReadTimer];
    }
...
- (void)laodSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MokoLifeX", @"MKLFXCPowerReportController", @"lfx_saveIcon.png") forState:UIControlStateNormal];
