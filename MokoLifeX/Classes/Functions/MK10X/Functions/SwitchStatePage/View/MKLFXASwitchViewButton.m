...
@implementation MKLFXASwitchViewButtonModel
@end

@interface MKLFXASwitchViewButton ()
...
@implementation MKLFXASwitchViewButton
...
#pragma mark - setter
- (void)setDataModel:(MKLFXASwitchViewButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKLFXASwitchViewButtonModel.class]) {
        return;
    }
