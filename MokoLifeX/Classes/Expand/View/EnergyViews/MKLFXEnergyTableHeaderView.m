...
@implementation MKLFXEnergyTableHeaderViewModel
@end

@interface MKLFXEnergyTableHeaderView ()
...
@implementation MKLFXEnergyTableHeaderView
...
#pragma mark - setter
- (void)setDataModel:(MKLFXEnergyTableHeaderViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKLFXEnergyTableHeaderViewModel.class]) {
        return;
    }
